...
import swd20.C4.bookstore.web.UserDetailServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/editbook/{id}", "/deletebook/{id}").hasAuthority("ADMIN") // admin pääsee käsiksi vain näihin määrittyihin endpointeihin
